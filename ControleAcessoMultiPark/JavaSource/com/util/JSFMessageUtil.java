...
public class JSFMessageUtil {
	...
	public static Object getVariavelApplication(String nomeDaVariavel) {
		...
		Object obj = FacesContext.getCurrentInstance().getApplication()
				.getELResolver().getValue(elContexto, null, nomeDaVariavel);
	...
	public static Object getValorExpressao(String expressao) {
		...
		ValueExpression expression = app.getExpressionFactory()
				.createValueExpression(contexto.getELContext(),
	...
	public static void limparObjetosSessao(String nomeChave) {
		for (String chave : getSessionMap().keySet()) {
			if (chave.contains(nomeChave)) {
				System.out.println("JSFMessaUtil.limparObjetosSessao() <> " + chave);
